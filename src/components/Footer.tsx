  ...
  return (
    <VStack w='100%' spacing={0}>
      ...
      <Stack
        ...
        w='100%'
        color='white'
        px={{ base: 7, lg: 24, xl: 32, '2xl': 44 }}
        pt={{ base: 10, lg: 14 }}
      >
        <VStack align='start' spacing={2}>
          <Icon viewBox='0 0 240 36' w={56} h={10} color='white'>
